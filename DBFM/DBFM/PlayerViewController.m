...
#define kGoldColor RGB(219, 196, 175)//app的背景颜色
...
@property (strong, nonatomic) UILabel *channelTitleLabel;//频道主题名

@property (strong, nonatomic) UIImageView *albumCoverImage;//专辑照片
@property (strong, nonatomic) UIImageView *albumCoverMaskImage;//专辑封面照片

@property (strong, nonatomic) UIProgressView *timerProgressBar;//时间
@property (strong, nonatomic) UILabel *timeLabel;//

@property (strong, nonatomic) UILabel *songTitleLabel;//歌曲名
@property (strong, nonatomic) UILabel *songArtistLabel;//歌手名

@property (strong, nonatomic) UIButton *pauseButton;//暂停
@property (strong, nonatomic) UIButton *likeButton;//标记为喜欢
...
- (void)viewDidLoad {
    ...
    [self p_loadPlaylist];
    [PlayerController sharedInstance].songInfoDelegate = self;//播放控制
